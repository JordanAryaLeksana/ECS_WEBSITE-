  ...
  return (
    <Layout>
      <div className=" h-full w-full min-h-screen bg-primary-normal-normal overflow-x-hidden">
        <div className=" relative h-screen w-full flex flex-col items-center justify-center min-h-screen space-y-4 px-4 md:px-8 lg:px-16 mt-8">
          {/* Logo and About Us */}
          <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4 items-center lg:items-start">
            <div className="w-full relative lg:w-[358px] h-[240px] rounded-2xl bg-AddsOn-gray border-[0.2px] border-opacity-10 border-AddsOn-white bg-opacity-10 transition-all text-AddsOn-white duration-300 flex items-center justify-center">
              <Image
          ...
          <div className="relative w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 ">
        ...
        <div className="relative h-screen w-screen">
          ...
          <Image src="/about/fotoecs.png" alt="" className=" w-full mt-10 absolute bottom-0" width={1380} height={700} />
